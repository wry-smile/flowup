...
export default function BehaviorPanel({ items, onPatchItems }: Props) {
        ...
        <div class="flex items-center justify-between gap-2">
          ...
          <div class="flex items-center justify-between gap-2">
            ...
            <button
              ...
              type="button"
              onClick={() => onPatchItems([...items, `Item ${items.length + 1}`])}
            >
              + Add
            </button>
          </div>
            ...
            {items.map((item, index) => (
              <li key={`${item}-${index}`}>
                ...
                <button
                  ...
                  onClick={() => onPatchItems(items.filter((_, itemIndex) => itemIndex !== index))}
                >
                  ×
                </button>
              </li>
