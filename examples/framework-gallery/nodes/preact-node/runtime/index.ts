...
export default function nodeInit(RED: NodeAPI): void {
  function FrameworkGalleryPreactNodeNodeConstructor(this: RedNode, config: FrameworkGalleryPreactNodeNodeDef): void {
    ...
    const settings = {
      ...
      items: Array.isArray(config.items) ? [...config.items] : ['Preact', 'Vue', 'Solid'],
    }
  ...
  RED.nodes.registerType<FrameworkGalleryPreactNodeNode, FrameworkGalleryPreactNodeNodeDef, {}, {}>(
    NODE_NAME,
    FrameworkGalleryPreactNodeNodeConstructor,
  )
}
