...
export default function nodeInit(RED: NodeAPI): void {
  function FrameworkGalleryVueNodeNodeConstructor(this: RedNode, config: FrameworkGalleryVueNodeNodeDef): void {
  ...
  RED.nodes.registerType<FrameworkGalleryVueNodeNode, FrameworkGalleryVueNodeNodeDef, {}, {}>(
    NODE_NAME,
    FrameworkGalleryVueNodeNodeConstructor,
  )
}
