...
<section class="overflow-hidden rounded-xl border border-slate-200 bg-white">
  ...
  <div class="grid grid-cols-3 gap-2 p-3.5 max-[480px]:grid-cols-1">
    <div class="rounded-lg bg-slate-50 p-2.5">
      <span class="grid size-7 place-items-center rounded-md bg-indigo-100 text-indigo-700">Aa</span>
    ...
    >
      <span class="grid size-7 place-items-center rounded-md bg-indigo-100 text-indigo-700">▣</span>
...
<DialogRoot open={dialogOpen} onClose={() => (dialogOpen = false)} />
