...
export default function nodeInit(RED: NodeAPI): void {
  function FrameworkGalleryVanillaNodeNodeConstructor(this: RedNode, config: FrameworkGalleryVanillaNodeNodeDef): void {
    ...
    const settings = {
      ...
      items: Array.isArray(config.items) ? [...config.items] : ['Vanilla', 'Vue', 'Solid'],
    }
  ...
  RED.nodes.registerType<FrameworkGalleryVanillaNodeNode, FrameworkGalleryVanillaNodeNodeDef, {}, {}>(
    NODE_NAME,
    FrameworkGalleryVanillaNodeNodeConstructor,
  )
}
